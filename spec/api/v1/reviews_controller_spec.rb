...
#     let!(:review1) {Review.create(rating: 5, body:"Awesome design on this shirt. It's a great gift for the Garfield fan in your life. My only concern is that it is a bit short in the length from neck to waste.", product: product1, user: user1)}
#     let!(:review2) {Review.create(rating: 4, body:"My kid looked so cute for Thanksgiving in his Garfield tee!", product: product1, user: user1)}
